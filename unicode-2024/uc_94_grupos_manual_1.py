# Este programa trabaja con Twemoji jdeked en vez de con Twemoji original
...
def incluye_emojis():
    ...
    twemoji_completo = os.listdir(ucdef.DIRECTORIO_TWEMOJI_JDECKED)
    restos_twemoji = []
...
def exporta_lista():
    destino = ucdef.FICHERO_MANUAL_1_TWEMOJI_JDECKED
    print()
...
def main():
    ...
    p_1 = pathlib.Path(ucdef.FICHERO_MANUAL_1_TWEMOJI_JDECKED)
    respuesta = "N"
    if p_1.exists():
