...
uc_grupos_parejas = [
    ...
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a familias formadas por dos miembros: un padre o una madre y un hijo o una hija. Estas secuencias se forman con tres caracteres, combinando los caracteres de hombre, mujer, niña o niño, como se comenta en el <a href="html-unicode-secuencias.html#gr-familias-1">apartado Familias de 2 miembros de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-familias-2", "Familias de 3 miembros",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a familias formadas por tres miembros: uno o dos progenitores y uno o dos hijos. Estas secuencias se forman con cinco caracteres, combinando los caracteres de hombre, mujer, niña o niño, como se comenta en el <a href="html-unicode-secuencias.html#gr-familias-2">apartado Familias de 3 miembros de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-familias-3", "Familias de 4 miembros",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a familias formadas por cuatro miembros: dos progenitores y dos hijos. Estas secuencias se forman con siete caracteres, combinando los caracteres de hombre, mujer, niña o niño, como se comenta en el <a href="html-unicode-secuencias.html#gr-familias-3">apartado Familias de 4 miembros de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-mano-piel-1", "Parejas masculinas/femeninas de la mano, con el mismo tono de piel",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a parejas con género (es decir, identificando si cada miembro de la pareja es hombre o mujer), con modificadores Fitzpatrick común (los dos personajes tienen el mismo color de piel). Estas secuencias se forman con dos caracteres, combinando los caracteres de parejas y los modificadores Fitzpatrick, como se comenta en el <a href="html-unicode-secuencias.html#gr-parejas-mano-piel-1">apartado Parejas masculinas/femeninas de la mano, con el mismo tono de piel, de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-mano-piel-2", "Parejas masculinas/femeninas de la mano, con dos tonos de piel",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a parejas con género (es decir, identificando si cada miembro de la pareja es hombre o mujer), con modificadores Fitzpatrick distintos (los dos personajes tienen distinto color de piel). Estas secuencias se forman con siete caracteres, combinando los carácteres hombre y/o mujer y los modificadores Fitzpatrick con el caráter apretón de manos, como se comenta en el <a href="html-unicode-secuencias.html#gr-parejas-mano-piel-2">apartado Parejas masculinas/femeninas de la mano, con dos tonos de piel, de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-mano-piel-3", "Parejas neutras de la mano, con dos tonos de piel",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a parejas neutras (con personajes ni femeninos ni masculinos), con modificadores Fitzpatrick. Estas secuencias se forman con siete caracteres, combinando combinando dos <i>emojis</i> que representan a adultos con los modificadores Fitzpatrick y con el caráter apretón de manos, como se comenta en el <a href="html-unicode-secuencias.html#gr-parejas-mano-piel-3">apartado Parejas neutras de la mano, con dos tonos de piel, de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-corazon-1", "Rostros masculinos/femeninos de enamorados",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a rostros de enamorados. Estas secuencias se forman con cinco caracteres, combinando los caracteres de hombre y/o mujer, con el carácter corazón, como se comenta en el <a href="html-unicode-secuencias.html#gr-parejas-corazon-1">apartado Rostros masculinos/femeninos de enamorados de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-corazon-piel-1", "Rostros masculinos/femeninos de enamorados, con dos tonos de piel (1)",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a rostros de enamorados, con modificadores Fitzpatrick. Estas secuencias se forman con siete caracteres, combinando los caracteres de hombre y/o mujer, con modificadores Fitzpatricl y con el carácter corazón, como se comenta en el <a href="html-unicode-secuencias.html#gr-parejas-corazon-piel-1">apartado Rostros masculinos/femeninos de enamorados, con dos tonos de piel (1) de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-corazon-piel-2", "Rostros masculinos/femeninos de enamorados, con dos tonos de piel (2)",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a rostros de enamorados, con modificadores Fitzpatrick. Estas secuencias se forman con ocho caracteres, combinando los caracteres de hombre y/o mujer, con modificadores Fitzpatrick y con el carácter corazón, como se comenta en el <a href="html-unicode-secuencias.html#gr-parejas-corazon-piel-2">apartado Rostros masculinos/femeninos de enamorados, con dos tonos de piel (2) de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-corazon-piel-3", "Rostros neutros de enamorados, con dos tonos de piel (1)",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a parejas neutras (con personajes ni femeninos ni masculinos), con modificadores Fitzpatrick distintos (los dos personajes tienen distinto color de piel). Estas secuencias se forman con siete caracteres, combinando combinando dos <i>emojis</i> que representan a adultos con los modificadores Fitzpatrick y con el caráter corazón, como se comenta en el <a href="html-unicode-secuencias.html#gr-parejas-corazon-piel-3">apartado Rostros neutros de enamorados, con dos tonos de piel (1), de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-corazon-piel-4", "Rostros neutros de enamorados, con dos tonos de piel (2)",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a parejas neutras (con personajes ni femeninos ni masculinos), con modificadores Fitzpatrick distintos (los dos personajes tienen distinto color de piel). Estas secuencias se forman con ocho caracteres, combinando combinando dos <i>emojis</i> que representan a adultos con los modificadores Fitzpatrick y con el caráter corazón, como se comenta en el <a href="html-unicode-secuencias.html#gr-parejas-corazon-piel-4">apartado Rostros neutros de enamorados, con dos tonos de piel (2), de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-beso-1", "Rostros masculinos/femeninos de enamorados besándose",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a rostros de enamorados besándose. Estas secuencias se forman con siete caracteres, combinando los caracteres de hombre y/o mujer, con los caracteres corazón y marca de labios, como se comenta en el <a href="html-unicode-secuencias.html#gr-parejas-beso-1">apartado Rostros masculinos/femeninos de enamorados besándose, de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-beso-piel-1", "Rostros masculinos/femeninos de enamorados besándose, con dos tonos de piel (1)",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a rostros de enamorados besándose, con modificadores Fitzpatrick. Estas secuencias se forman con nueve caracteres, combinando los caracteres de hombre y/o mujer, con modificadores Fitzpatrick y con los caracteres corazón y marca de labios, como se comenta en el <a href="html-unicode-secuencias.html#r-parejas-beso-piel-1">apartado Rostros masculinos/femeninos de enamorados besándose, con dos tonos de piel (1), de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-beso-piel-2", "Rostros masculinos/femeninos de enamorados besándose, con dos tonos de piel (2)",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a rostros de enamorados besándose, con modificadores Fitzpatrick. Estas secuencias se forman con diez caracteres, combinando los caracteres de hombre y/o mujer, con modificadores Fitzpatrick y con los caracteres corazón y marca de labios, como se comenta en el <a href="html-unicode-secuencias.html#r-parejas-beso-piel-2">apartado Rostros masculinos/femeninos de enamorados besándose, con dos tonos de piel (2), de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-beso-piel-3", "Rostros neutros de enamorados besándose, con dos tonos de piel (1)",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a rostros de personajes neutros (ni femeninos ni masculinos), con modificadores Fitzpatrick distintos (los dos personajes tienen distinto color de piel). Estas secuencias se forman con nueve caracteres, combinando combinando dos <i>emojis</i> que representan a adultos con los modificadores Fitzpatrick y con los caracteres corazón y marca de labios, como se comenta en el <a href="html-unicode-secuencias.html#gr-parejas-beso-piel-3">apartado Rostros neutros de enamorados besándose, con dos tonos de piel (1), de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
    ["gr-parejas-beso-piel-4", "Rostros neutros de enamorados besándose, con tonos de piel (2)",
    '    <p>En este apartado se muestran las secuencias Unicode ZWJ que corresponden a rostros de personajes neutros (ni femeninos ni masculinos), con modificadores Fitzpatrick distintos (los dos personajes tienen distinto color de piel). Estas secuencias se forman con diez caracteres, combinando combinando dos <i>emojis</i> que representan a adultos con los modificadores Fitzpatrick y con los caracteres corazón y marca de labios, como se comenta en el <a href="html-unicode-secuencias.html#gr-parejas-beso-piel-4">apartado Rostros neutros de enamorados besándose, con dos tonos de piel (2), de la lección Secuencias Unicode</a>.</p>\n\n', ORDENA_ESPECIAL_NO
    ],
]
