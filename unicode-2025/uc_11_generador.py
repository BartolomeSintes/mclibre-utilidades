...
def genera_pagina_twemoji(pagina):
    ...
    for grupo in grupos:
        ...
        if contador > 0:
            ...
            t += f'Unicode del grupo que se extiende desde el carácter U+{grupo[3]} hasta el carácter U+{grupo[4]}. Puede descargar la <a href="unicode/{grupo[2]}">tabla de códigos de caracteres Unicode 17.0</a> en formato PDF.</p>\n'
            t += "\n"
            t += '    <div class="u-l">\n'
            for c in caracteres:
                if len(c[0]) > 1:
        ...
        for grupo in imp4.seleccion_simbolos_manual:
            ...
            if contador > 0:
                ...
                if contador == 1:
                    ...
                    t += f"    <p>Se muestran aquí {contador} caracteres "
                t += f'Unicode del grupo que se extiende desde el carácter U+{grupo[0][3]} hasta el carácter U+{grupo[0][4]}. Puede descargar la <a href="unicode/{grupo[0][2]}">tabla de códigos de caracteres Unicode 17.0</a> en formato PDF.</p>\n'
                t += "\n"
                t += '    <div class="u-l">\n'
                for c in caracteres:
